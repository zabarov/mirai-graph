...
It shows how a character constitution can define principles, require virtues,
set boundaries, support a role character profile, drive a reflection protocol,
exercise a fixture, record a violation pattern and route correction through a
