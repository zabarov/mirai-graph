...
- [AI Employee Graph Adoption](adoption/ai-employee-graph.md)
- [Character Layer Adoption](adoption/character-layer.md)
- [Profile Conformance Fixtures](adoption/profile-conformance-fixtures.md)
...
Instrumentation, routing and governance:
...
- [Graph As AI Brain](../standard/graph-as-ai-brain.md)
...
Proposal or experimental profile:

- [Societal Governance](../profiles/societal-governance/README.md)

## Examples, Templates And Playground
...
- [Scientific Evidence Package](research/scientific-evidence-package.md)
- [Evidence Package v0.3](research/evidence-package-v0.3.md)
...
Transfer documents explain how public-safe ideas entered Mirai Graph. They are
not the primary adoption path for new users:

- [Transfer Notes](transfer/)
- [Alpha Release Notes](../releases/)
