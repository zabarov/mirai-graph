...
const reportRef = "releases/2.2.0-rc.1-readiness.json";
...
if (packageMajor < reportMajor || (packageMajor === reportMajor && packageMinor < reportMinor) ||
    (packageMajor === reportMajor && packageMinor === reportMinor && packagePatch < reportPatch)) {
  errors.push("evaluated_version_newer_than_package");
}
