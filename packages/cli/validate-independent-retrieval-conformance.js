...
const candidate = JSON.parse(fs.readFileSync(path.join(root, "conformance/independent-checker-2.4-candidate.json"), "utf8"));
const mappings = [
  ["index-descriptor", "examples/mirai-retrieval-minimal/results/index-descriptor.json", "conformance/results/python-mirai-2.4-index-descriptor-result.json"],
  ["plan", "examples/mirai-retrieval-minimal/results/plan.json", "conformance/results/python-mirai-2.4-plan-result.json"],
  ["evidence-bundle", "examples/mirai-retrieval-minimal/results/evidence-bundle.json", "conformance/results/python-mirai-2.4-evidence-result.json"],
  ["answer", "examples/mirai-retrieval-minimal/results/answer.json", "conformance/results/python-mirai-2.4-answer-result.json"],
  ["evaluation", "examples/mirai-retrieval-minimal/results/evaluation.json", "conformance/results/python-mirai-2.4-evaluation-result.json"]
];
const errors = [];
...
process.stdout.write(`${JSON.stringify({ valid, revision: candidate.revision, mirai_reference_revision: candidate.mirai_reference_revision, result_count: mappings.length, publication_status: candidate.publication_status, release_gate_eligible: valid && candidate.release_gate_eligible === true, errors }, null, 2)}\n`);
