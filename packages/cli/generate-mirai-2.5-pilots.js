...
const aggregate = aggregateOutcomes(parentContract, [{ contract: childContract, candidates: childCandidates, evidence: childEvidence, assessment: childA }, { contract: childContract, candidates: childCandidates, evidence: childEvidence, assessment: childB }]);
const incompleteCandidates = candidates("incomplete-child", childContract, ["spec"]);
const incompleteChild = assessOutcome(childContract, incompleteCandidates, childEvidence);
const incompleteAggregate = aggregateOutcomes(parentContract, [{ contract: childContract, candidates: childCandidates, evidence: childEvidence, assessment: childA }, { contract: childContract, candidates: incompleteCandidates, evidence: childEvidence, assessment: incompleteChild }]);
