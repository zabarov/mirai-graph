...
if (args[0] !== "prepare" || !args.includes("--allow-download") || !value("--revision")) {
  process.stderr.write("Usage: mirai-embedding-local prepare --allow-download --cache <dir> --revision <sha> [--model <id>] [--license <spdx>]\n");
  process.exit(1);
}
